...
> [!WARNING]
> This tool generates preview cards by linking to publicly available GitHub content and GitHub's own OpenGraph image service. It does not host, moderate, or control the content of the linked repositories, issues, commits, etc. The maintainer is not responsible for the content of any GitHub resource generated or linked to through this tool.
...
1. Open the [live app](https://github-card-creator.vercel.app) (or your local dev server).
2. Paste a GitHub link — a repository, issue, pull request, discussion, or release.
3. Preview the generated card.
4. Download the card image or copy the embeddable link/HTML for use elsewhere.
